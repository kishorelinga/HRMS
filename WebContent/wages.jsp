...
<div class="container">
  <h2 class="text-center text-primary">Wages</h2>
    <div class="clear">&#x00A0;</div>
        <div class="clear">&#x00A0;</div>
     <s:form action="wagesInsert"   method="post" >  
     <table>
         
        <td><s:textfield id="i" name="form.empId" label="Employee Id" cssClass="form-control form-group " placeholder="Enter Employee Id"></s:textfield></td> 
         
        <td><s:select id="i" list="wageIdList"  name="form.wageId" label="Wage Id" cssClass="form-control form-group" headerKey="-1" headerValue=" -- Select -- "></s:select></td> 
         
        <td><s:textfield id="i" name="form.basicRate"  label="Basic Rate" cssClass="form-control form-group " placeholder="Enter Basic Rate" ></s:textfield></td> 
         
        <td><sj:datepicker readonly="true" changeYear="true" changeMonth="true" size="90" name="form.effectiveDate" label="Effective Date" cssClass="lab" displayFormat="dd-mm-yy" placeholder="dd-mm-yyyy"></sj:datepicker></td> 
