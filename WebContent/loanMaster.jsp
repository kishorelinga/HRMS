  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="Quarters.jsp">Gas Connections</a></li>
...
<div class="btn-group dropup">
  <s:form action="loanEnroll">
      <s:submit value="Add Loan Application Master" cssClass="btn btn-primary activated1"/>
  </s:form>
       </div>
...
<s:iterator value="loan" status="rowstatus">
<tr>
    <td><s:property value="#rowstatus.count" /></td>
 <td> <s:property value="loanId" ></s:property></td>
 <td> <s:property value="loanTypeName"></s:property></td>
 <td><s:property value="empGrade"></s:property></td>
<td><a href="loanEdit?id1=<s:property value='loanId' /> " > <img src="images/edit.png" alt="images" /></a></td>
<td><a href="loanDelete?id1=<s:property value='loanId' /> " onclick="return confirm('Are u Sure ?')"> <img src="images/delete.png" alt="images" /></a></td>
</tr>
</s:iterator>
