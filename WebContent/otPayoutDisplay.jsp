...
<div class="btn-group dropup">
  <s:form action="otPayoutenroll">
      <s:submit value="Add Overtime Payout" cssClass="btn btn-primary activated1"/>
  </s:form>
       </div>
...
<s:iterator value="otPayoutList" status="rowstatus" >
<tr>
 <td><s:property value="#rowstatus.count" /></td>
 <td> <s:property value="wageDefinitions.wageId" ></s:property></td>
 <td> <s:property value="payoutDays"></s:property></td>
<%-- <td><a href="otPayoutview?id1=<s:property value='id' /> " > <img src="images/view.png" alt="images" /></a></td></td> --%>
<td><a href="otPayoutedit?id1=<s:property value='id' /> " > <img src="images/edit.png" alt="images" /></a></td>
<td><a href="otPayoutdelete?id1=<s:property value='id' /> " onclick="return confirm('Are u Sure ?')"> <img src="images/delete.png" alt="images" /></a></td>
</tr>
</s:iterator>
