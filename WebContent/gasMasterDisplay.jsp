...
<!--            <li><a href="MyProfile.html">My Profile</a></li>
 ...
 <h2 class="text-center text-primary">Gas Connection Master</h2>
<div class="btn-group dropup">
  <s:form action="gasMasterenroll">
...
<tr class="info">
<th>S.No</th>
<th>Gas Connection ID</th>
<th>Gas Company Name</th>
<th>Gas Connection Holder Name</th>

<th>Edit</th>
<th>Delete</th>
</tr>
<s:iterator value="masterList" status="rowstatus">
<tr>
    <td><s:property value="#rowstatus.count" /></td>
 <td> <s:property value="connectionId" ></s:property></td>
 <td> <s:property value="gasCompanyName"></s:property></td>
 <td> <s:property value="gasConnectionHolderName" ></s:property></td>
<%-- <td><a href="viewgasmaster?id1=<s:property value='connectionId' /> " > <img src="images/view.png" alt="images" /></a></td></td> --%>
<td><a href="gasMasteredit?id1=<s:property value='connectionId' /> " > <img src="images/edit.png" alt="images" /></a></td>
<td><a href="gasMasterdelete?id1=<s:property value='connectionId' /> " onclick="return confirm('Are u Sure ?')"> <img src="images/delete.png" alt="images" /></a></td>
</tr>
</s:iterator>
