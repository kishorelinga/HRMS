...
<div class="btn-group dropup">
  <s:form action="wagesEnroll">
      <s:submit value="Add Wage" cssClass="btn btn-primary activated1"/>
  </s:form>
       </div>
...
<s:iterator value="wageList" status="rowstatus">
<tr>
 <td><s:property value="#rowstatus.count" /></td>
 <td> <s:property value="wageDefinitions.wageId" ></s:property></td>
 <td> <s:property value="basicRate"></s:property></td>
 <td><s:date format="dd-MM-yyyy" name="%{effectiveDate}" var="date"/><s:property value="%{date}" ></s:property></td>
 <td><s:property value="employeeProfile.empId"></s:property> </td> 
<td><a href="wagesEdit?id1=<s:property value='id' /> " > <img src="images/edit.png" alt="images" /></a></td>
<td><a href="wagesDelete?id1=<s:property value='id' /> " onclick="return confirm('Are u Sure ?')"> <img src="images/delete.png" alt="images" /></a></td>
</tr>
</s:iterator>
