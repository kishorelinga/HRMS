...
<div class="container">
  <h2 class="text-center text-primary">Deduction Rules</h2>
    ...
    <s:form action="deductionInsert" method="post">
        <table>
           
            <tr>
                <td><s:textfield id="i" name="dform.deductionRuleId"  label="Deduction Rule Id" size="90" cssClass="form-control form-group "></s:textfield></td>
                
                    <td><s:select id="i" name="dform.empGrade" list="gradeList" headerKey="-1" headerValue="--Select--" label="employee Grade " cssClass="form-control form-group "></s:select></td>
           
                    <td><s:textfield id="i" name="dform.flatDeductionAmount"  label="Flat Deduction Amount" cssClass="form-control form-group"></s:textfield></td>
            
                    <td><s:textfield id="i" name="dform.basicRate" label="Basic Rate" cssClass="form-group form-control"></s:textfield></td>
            </tr>
        </table>
            <br/><br/>
   <div class="form-group">
