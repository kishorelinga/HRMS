...
<div class="container">
  <h2 class="text-center text-primary">Loan Application Master</h2>
    ...
    <s:form action="loanUpdate" method="post">
        <table>
            <s:iterator value="loan1">
                
                
            <tr>
                <td><s:textfield id="i" name="lform.loanId" value="%{loanId}" label="Loan Type Id" size="90" cssClass="form-control form-group "></s:textfield></td>
                
                    <td><s:textfield id="i" name="lform.loanTypeName" value="%{loanTypeName}" label="Loan Type Name" cssClass="form-control form-group "></s:textfield></td>
           
                    <td><s:select id="i" name="lform.eligibilityRuleId" value="%{loanEligibility.eligibilityRuleId}" list="loanEligibilityList" headerKey="-1" headerValue=" --Select-- " label="Loan Eligibility Role Id" cssClass="form-control form-group "></s:select></td>
           
                    <td><s:select id="i" name="lform.empGrade" list="empGradeList" value="%{empGrade}" headerKey="-1" headerValue=" --Select-- " label="Employee Grade" cssClass="form-control form-group "></s:select> </td>
            </tr>
            </s:iterator>
        </table>
   <br/><br/>
