...
<div class="container">
  <h2 class="text-center text-primary">Departments</h2>
    ...
    <s:form action="deptUpdate" method="post">
        <table>
            <s:iterator value="dept">
                
                
            <tr>
                <td><s:textfield id="i" name="df.deptId" value="%{deptId}" label="Department Id" size="90" cssClass="form-control form-group "></s:textfield></td>
                
                    <td><s:textfield id="i" name="df.deptName" value="%{deptName}" label="Department Name" cssClass="form-control form-group "></s:textfield></td>
           
                    <td><s:textfield id="i" name="df.deptScope" value="%{deptScope}" label="Department Scope" cssClass="form-control form-group"></s:textfield></td>
            </tr>
            </s:iterator>
        </table>
   <br/><br/>
