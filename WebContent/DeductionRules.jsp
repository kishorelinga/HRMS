<%-- 
    Document   : DeductionRules
    Created on : Nov 22, 2016, 10:54:05 AM
    Author     : NSG
--%>
...
<div class="btn-group dropup">
  <s:form action="deductionEnroll">
      <s:submit value="Add Deduction" cssClass="btn btn-primary activated1"/>
  </s:form>
       </div>
...
<tr>
 ...
 <td> <s:property value="deductionRuleId" ></s:property></td>
 <td> <s:property value="empGrade"></s:property></td>
<td><a href="deductionEdit?id1=<s:property value='deductionRuleId' /> " data-toggle="tooltip" data-placement="bottom" title="Edit"> <img src="images/edit.png" alt="images" /></a></td>
<td><a href="deductionDelete?id1=<s:property value='deductionRuleId' /> " data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return confirm('Are u Sure ?')"> <img src="images/delete.png" alt="images" /></a></td>
</tr>
</s:iterator>
