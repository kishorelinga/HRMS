<%-- 
    ...
    Created on : Nov 21, 2016, 12:48:44 PM
    Author     : NSG
--%>
...
<div class="container">
  <h2 class="text-center text-primary">Departments</h2>
    <div class="clear">&#x00A0;</div>
        <div class="clear">&#x00A0;</div>
     <s:form action="deptInsert"  enctype="multipart/form-data" method="post" >          
        
         <table>
             <td><s:textfield id="i" name="df.deptId" label="Department Id" size="90" cssClass="form-control form-group" placeholder="Enter Department Id"></s:textfield></td>
             
                 <td><s:textfield id="i" name="df.deptName" label="Department Name" cssClass="form-control form-group" placeholder="Enter Department Name"></s:textfield></td>
         
                 <td><s:textfield id="i" name="df.deptScope" label="Department Scope" cssClass="form-group form-control" placeholder="Enter Department Scope"></s:textfield></td>
         </table>
         <br/><br/>
          <div class="form-group">
      ...
      <div class="col-sm-6 text-center"> 
          <button type="button" class="btn btn-default" ><a href="deptDisplay" style="text-decoration:none; color:black">Cancel</a></button>
          </div>
      </div> 
    </s:form>
        </center>
