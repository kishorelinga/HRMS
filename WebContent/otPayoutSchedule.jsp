...
<div class="container">
  <h2 class="text-center text-primary">OT Payout Schedule</h2>
    <div class="clear">&#x00A0;</div>
        <div class="clear">&#x00A0;</div>
     <s:form action="otPayoutinsert"  enctype="multipart/form-data" method="post" >  
     <table>
         <td><s:select id="i" list="otList"  name="form.wageId" label="Wage Id"  cssClass="form-control form-group " headerKey="-1" headerValue=" --Select--" autofocus="autofocus"></s:select></td> 
            
         <td><s:textfield id="i" size="90" name="form.payoutDays" label="Payout Days" cssClass="form-control form-group" placeholder="Enter Payout Days"></s:textfield></td> 
     </table>
     <div class="form-group">
     <div class="form-group">
